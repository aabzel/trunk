...
ifneq ($(HEALTH_MONITOR_MK_INC),Y)
    ...
    # $(error HEALTH_MONITOR_DIR=$(HEALTH_MONITOR_DIR))
    ...
    ifeq ($(DIAG),Y)
        ifeq ($(HEALTH_MONITOR_DIAG),Y)
            MCAL_OPT += -DHAS_HEALTH_MONITOR_DIAG
            # $(error HEALTH_MONITOR_DIAG=$(HEALTH_MONITOR_DIAG))
    ...
    ifeq ($(CLI),Y)
        ifeq ($(HEALTH_MONITOR_COMMANDS),Y)
            MCAL_OPT += -DHAS_HEALTH_MONITOR_COMMANDS
