...
#define HOUR_2_SEC(HOUR) ((HOUR) * 60.0f * 60.0f)
#define DAY_2_SEC(DAYS) (((float)(DAYS)) * 86400.0f)
#define WEEK_2_SEC(WEEKS) (((float)(WEEKS)) * 604800.0f)
#define HOUR_2_MIN(HOUR) (((float)(HOUR)) * 60.0f)
#define MIN_2_SEC(MIN) ((MIN) * 60.0f)
#define MIN_2_MS(MIN) ((MIN)*60U * 1000U)
#define MIN_2_US(MIN) ((60000000UL * (MIN)))
...
float sec_to_msec(float  seconds) ;//((((float)(SEC)) * 1000.0))
