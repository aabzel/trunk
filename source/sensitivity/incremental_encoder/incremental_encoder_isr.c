...
static inline IncrementalEncoderInput_t
incremental_encoder_spot_event(IncrementalEncoderHandle_t* Node, const Pad_t Pad, const PinIntEdge_t edge_effective) {
