...
message(STATUS "PWM_NRFX_DRV_MK_INC=${PWM_NRFX_DRV_MK_INC}")
if( NOT (PWM_NRFX_DRV_MK_INC STREQUAL Y))
    set(PWM_NRFX_DRV_MK_INC Y)

    message(STATUS "+ PWM NRFX")
    set(PWM_NRF_DIR ${MCAL_NRF5340_DIR}/pwm)
    ...
    target_compile_definitions(app PUBLIC HAS_PWM_NRFX)
    target_compile_definitions(app PUBLIC HAS_PWM_CUSTOM)
    #target_compile_definitions(app PUBLIC NRFX_PWM_ENABLED=1)

    #message( SEND_ERROR "You can't do that" )
    if (PWM0 STREQUAL Y)
        #target_compile_definitions(app PUBLIC NRFX_PWM0_ENABLED)
