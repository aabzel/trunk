...
typedef union {
    ...
    struct{
        ...
        uint32_t gpioi :1;/*IO port I clock enable*/
        ...
        uint32_t res3  :5;/*Reserved,*/
        uint32_t ETH_MAC_PTP_LP_EN  :1;/*ETHMACPTPLPEN: Ethernet PTP clock enable during Sleep mode*/
        uint32_t otg_hs_lp_en  :1;/*OTGHSLPEN: USB OTG HS clock enable during Sleep mode*/
        uint32_t otg_hs_ulpi_lp_en  :1;/*OTGHSULPILPEN: USB OTG HS ULPI clock enable during Sleep mode*/
