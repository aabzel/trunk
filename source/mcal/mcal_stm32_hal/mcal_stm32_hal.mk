ifneq ($(MCAL_STM32FX_DRV_MK_INC),Y)
    MCAL_STM32FX_DRV_MK_INC=Y
    ...
    ifeq ($(HAL_MSP),Y)
        ...
        SOURCES_C += $(MCAL_CUSTOM_DIR)/stm32fx_hal_msp.c
    endif
    ...
    ifeq ($(ADC_CHANNEL),Y)   
        # $(error ADC_CHANNEL=$(ADC_CHANNEL))
        include $(MCAL_CUSTOM_DIR)/adc_channel/adc_channel.mk
    endif
    ...
    ifeq ($(DAC_CHANNEL),Y)
        include $(MCAL_CUSTOM_DIR)/dac_channel/dac_channel.mk
    endif

    ifeq ($(DAC_CUSTOM),Y)
        include $(MCAL_CUSTOM_DIR)/dac_custom/dac_custom.mk
    endif
    ...
    ifeq ($(DMA_CHANNEL),Y)   
        ...
        include $(MCAL_CUSTOM_DIR)/dma_channel/dma_channel.mk
    endif
