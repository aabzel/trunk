...
static TimerPolarity_t Stm32TimerPolarityToTimerPolarity(const Stm32TimerPolarity_t stm32_polarity) {
    ...
    case STM32_TIMER_OCX_ACTIVE_LOW:
        polarity = TIMER_POLARITY_LOW;
        break;
    case STM32_TIMER_OCX_ACTIVE_HIGH:
        polarity = TIMER_POLARITY_HIGH;
        break;
    default:
        polarity = TIMER_POLARITY_UNDEF;
        break;
    }
    return polarity;
}
...
static uint32_t TimerSlaveInModeToStm32SlaveInTrigMode(const TimerSlaveInTrigger_t slave_input_trigger) {
    ...
    case TIMER_SLAVE_IN_TRIG_INTERNAL_TRIGGER_0:
        InputTrigger = TIM_TS_ITR0;
        break;
    case TIMER_SLAVE_IN_TRIG_INTERNAL_TRIGGER_1:
        InputTrigger = TIM_TS_ITR1;
        break;
    case TIMER_SLAVE_IN_TRIG_INTERNAL_TRIGGER_2:
        InputTrigger = TIM_TS_ITR2;
        break;
    case TIMER_SLAVE_IN_TRIG_INTERNAL_TRIGGER_3:
        InputTrigger = TIM_TS_ITR3;
        break;
    case TIMER_SLAVE_IN_TRIG_TI1_EDGE_DETECTOR:
        InputTrigger = TIM_TS_TI1F_ED;
        break;
    case TIMER_SLAVE_IN_TRIG_FILTERED_TIMER_INPUT_1:
        InputTrigger = TIM_TS_TI1FP1;
        break;
    case TIMER_SLAVE_IN_TRIG_FILTERED_TIMER_INPUT_2:
        InputTrigger = TIM_TS_TI2FP2;
        break;
    case TIMER_SLAVE_IN_TRIG_FILTERED_EXTERNAL_TRIGGER_INPUT:
        InputTrigger = TIM_TS_ETRF;
        break;
    case TIMER_SLAVE_IN_TRIG_NO_TRIGGER_SELECTED:
        InputTrigger = TIM_TS_NONE;
        break;
    default:
        InputTrigger = TIM_TS_NONE;
        break;
...
static Stm32TimerPolarity_t TimerPolarityToStmPolarity(const TimerPolarity_t polarity) {
    ...
    switch(polarity) {
    case TIMER_POLARITY_LOW:
        stm32_polarity = STM32_TIMER_OCX_ACTIVE_LOW;
        break;
    case TIMER_POLARITY_HIGH:
        stm32_polarity = STM32_TIMER_OCX_ACTIVE_HIGH;
        break;
    default:
        stm32_polarity = STM32_TIMER_OCX_ACTIVE_HIGH;
        break;
...
uint32_t TimerSlaveModeToStm32SlaveMode(TimerSlaveMode_t slave_mode) {
    ...
    switch(slave_mode) {
    case TIMER_SLAVE_MODE_DISABLE:
        stm32_slave_mode = TIM_SLAVEMODE_DISABLE;
        break;
    case TIMER_SLAVE_MODE_RESET:
        stm32_slave_mode = TIM_SLAVEMODE_RESET;
        break;
    case TIMER_SLAVE_MODE_GATED:
        stm32_slave_mode = TIM_SLAVEMODE_GATED;
        break;
    case TIMER_SLAVE_MODE_TRIGGER:
        stm32_slave_mode = TIM_SLAVEMODE_TRIGGER;
        break;
    case TIMER_SLAVE_MODE_EXTERNAL1:
        stm32_slave_mode = TIM_SLAVEMODE_EXTERNAL1;
        break;
    case TIMER_SLAVE_MODE_UNDEF:
        stm32_slave_mode = TIM_SLAVEMODE_DISABLE;
        break;
    default:
        stm32_slave_mode = TIM_SLAVEMODE_DISABLE;
...
uint32_t TimerSlaveTriggerPolarityToStmTriggerPolarity(const TimerSlaveTriggerPolarity_t slave_trigger_polarity) {
    ...
    case TIMER_SLAVE_TRIGGER_POLARITY_INVERTED:
        TriggerPolarity = TIM_TRIGGERPOLARITY_INVERTED;
        break;
    case TIMER_SLAVE_TRIGGER_POLARITY_NONINVERTED:
        TriggerPolarity = TIM_TRIGGERPOLARITY_NONINVERTED;
        break;
    case TIMER_SLAVE_TRIGGER_POLARITY_RISING:
        TriggerPolarity = TIM_TRIGGERPOLARITY_RISING;
        break;
    case TIMER_SLAVE_TRIGGER_POLARITY_FALLING:
        TriggerPolarity = TIM_TRIGGERPOLARITY_FALLING;
        break;
    case TIMER_SLAVE_TRIGGER_POLARITY_BOTHEDGE:
        TriggerPolarity = TIM_TRIGGERPOLARITY_BOTHEDGE;
        break;
    default:
        TriggerPolarity = TIM_TRIGGERPOLARITY_INVERTED;
        break;
...
static uint32_t TimerSlaveTriggerPrescalerToStmTriggerPrescaler(const uint32_t slave_trigger_prescaler) {
    ...
    case 1:
        ...
        break;
    case 2:
        TriggerPrescaler = TIM_TRIGGERPRESCALER_DIV2;
        break;
    case 3:
        TriggerPrescaler = TIM_TRIGGERPRESCALER_DIV4;
        break;
    case 4:
        TriggerPrescaler = TIM_TRIGGERPRESCALER_DIV8;
        break;
    default:
        TriggerPrescaler = TIM_TRIGGERPRESCALER_DIV1;
        break;
...
static uint32_t TimerMasterOutputTriggerToStmMasterOutTg(const TimerMasterOutTrigger_t mas_out_tg) {
    ...
    switch(mas_out_tg) {
    case TIMER_MASTER_OUT_TRG_RESET:
        MasterOutputTrigger = TIM_TRGO_RESET;
        break;
    case TIMER_MASTER_OUT_TRG_ENABLE:
        MasterOutputTrigger = TIM_TRGO_ENABLE;
        break;
    case TIMER_MASTER_OUT_TRG_UPDATE:
        MasterOutputTrigger = TIM_TRGO_UPDATE;
        break;
    case TIMER_MASTER_OUT_TRG_OC1:
        MasterOutputTrigger = TIM_TRGO_OC1;
        break;
    case TIMER_MASTER_OUT_TRG_OC1REF:
        MasterOutputTrigger = TIM_TRGO_OC1REF;
        break;
    case TIMER_MASTER_OUT_TRG_OC2REF:
        MasterOutputTrigger = TIM_TRGO_OC2REF;
        break;
    case TIMER_MASTER_OUT_TRG_OC3REF:
        MasterOutputTrigger = TIM_TRGO_OC3REF;
        break;
    case TIMER_MASTER_OUT_TRG_OC4REF:
...
static bool timer_init_role_master(TimerHandle_t* Node) {
    ...
    MasterConfig.MasterOutputTrigger =
        TimerMasterOutputTriggerToStmMasterOutTg(Node->master_out_trigger); // TIM_TRGO_UPDATE;//TIM_TRGO_OC2REF;
