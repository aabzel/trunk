...
typedef enum {
    GPIO_DRIVE_STRENGTH_LOW = 1,
    GPIO_DRIVE_STRENGTH_HIGH = 2,

    GPIO_DRIVE_STRENGTH_UNDEF = 0,
}GpioDrive_t;
...
typedef enum {
    GPIO_SPEED_LOW_SPEED = 1,
    GPIO_SPEED_MEDIUM_SPEED = 2,
    GPIO_SPEED_FAST_SPEED = 3,
    GPIO_SPEED_HIGH_SPEED = 4,
