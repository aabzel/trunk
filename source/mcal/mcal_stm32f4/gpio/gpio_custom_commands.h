#ifndef GPIO_STM32_COMMANDS_H
#define GPIO_STM32_COMMANDS_H
...
#define GPIO_STM32_COMMANDS                                                                                                  \
        SHELL_CMD("sw_int", "sn", sw_interrupt_command, "SW int"),                                                     \
