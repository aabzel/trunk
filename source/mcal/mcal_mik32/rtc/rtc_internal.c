...
<<<<<<< HEAD
static uint32_t RtcFprmatToMik32Format(RtcFormat_t format) {
=======
...
<<<<<<< HEAD
        Node->h_rtc.Init.HourFormat = RtcFprmatToMik32Format(Node->format);
=======
 ...
 */
<<<<<<< HEAD
static uint8_t RtcMotchToMik32HalMonth(int tm_mon) {
=======
...
<<<<<<< HEAD
static uint8_t RtcWeekDayToMik32HalWeekDay(int tm_wday) {
=======
...
<<<<<<< HEAD
        HalDate.WeekDay = RtcWeekDayToMik32HalWeekDay(DateTime->tm_wday) ;
        HalDate.Month =  RtcMotchToMik32HalMonth(DateTime->tm_mon);
=======
