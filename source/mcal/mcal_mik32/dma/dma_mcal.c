...
<<<<<<< HEAD
static uint32_t MemoryBurst2Mik32MemoryBurst(uint8_t mem_burst) {
=======
...
<<<<<<< HEAD
static uint32_t PeriphBurst2Mik32PeriphBurst(DmaBurst_t periph_burst) {
=======
            ...
            if(Info) {
                ...
                if(Node) {
                    ...
                    if(ChannelInfo) {
                        ...
                        Node->dma_h.Init.Direction = DmaDirToMik32DmaDir(ChannelConfig->dir);
...
<<<<<<< HEAD
                        Node->dma_h.Init.MemBurst = MemoryBurst2Mik32MemoryBurst(ChannelConfig->memory_burst);
                        Node->dma_h.Init.PeriphBurst = PeriphBurst2Mik32PeriphBurst(ChannelConfig->periph_burst);
=======
