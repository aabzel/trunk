...
static uint32_t IvSkipCfg2Mik32SkipConfig(IvSkipCfg_t iv_skip_cfg){
...
<<<<<<< HEAD
        CrypNode->cryp_h.Init.KeyIVConfigSkip = IvSkipCfg2Mik32SkipConfig(iv_skip_cfg);
=======
...
<<<<<<< HEAD
            CrypNode->Conf.KeyIVConfigSkip =  IvSkipCfg2Mik32SkipConfig(iv_skip_cfg);
=======
