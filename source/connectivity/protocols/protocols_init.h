...
#ifdef HAS_DS_TWR
#include "ds_twr.h"
#define DS_TWR_INIT {.name="DsTwr", .init_function=ds_twr_init,},
#else
#define DS_TWR_INIT
#endif
...
#define IR_SAMSUNG_INIT {.name="IrSamsung", .init_function=ir_samsung_mcal_init,},
#else
#define IR_SAMSUNG_INIT
#endif

#ifdef HAS_ISO_TP
#include "iso_tp_mcal.h"

#define ISO_TP_INIT {.name="IsoTp", .init_function=iso_tp_mcal_init,},
#else
#define ISO_TP_INIT
#endif
...
#define PCAN_INIT {.name="pCan", .init_function=pcan_mcal_init,},
#else
#define PCAN_INIT
#endif
...
#ifdef HAS_SLCAN
#include "slcan.h"
#define SLCAN_INIT {.name="SLCAN", .init_function=slcan_mcal_init,},
#else
#define SLCAN_INIT
#endif
...
#define UDS_CLIENT_INIT {.name="UdsClient", .init_function = uds_client_mcal_init,},
#else
#define UDS_CLIENT_INIT
#endif
...
/*Order matters!*/
#define PROTOCOLS_WIRELESS_INIT    \
...
#define PROTOCOLS_INIT             \
    PROTOCOLS_WIRELESS_INIT        \
    PROTOCOLS_WIRED_INIT           \
    CLI_INIT                       \
    STRING_READER_INIT             \
    TBFP_INIT                      \
    PCAN_INIT
