ifneq ($(TBFP_PROTOCOL_MK),Y)
    ...
    MCAL_OPT += -DHAS_TBFP
    MCAL_OPT += -DHAS_TBFP_PROC

    ifeq ($(TBFP_ACK),Y)
        MCAL_OPT += -DHAS_TBFP_ACK
    endif

    ifeq ($(TBFP_EXT),Y)
        MCAL_OPT += -DHAS_TBFP_EXT
    endif

    ifeq ($(TBFP_FLOW_CONTROL),Y)
        MCAL_OPT += -DHAS_TBFP_FLOW_CONTROL
    endif

    ifeq ($(TBFP_RETRANSMIT),Y)
        MCAL_OPT += -DHAS_TBFP_RETRANSMIT
        ifeq ($(TBFP_DIAG),Y)
