ifneq ($(SW_COMPONENT_MK_INC),Y)
    ...
    SOURCES_C += $(SW_COMPONENT_DIR)/sw_component_mcal.c
    ...
    # must be outside
    SOURCES_CONFIGURATION_C += $(BOARD_CFG_DIR)/sw_component_config.c

    ifeq ($(DIAG),Y)
        ifeq ($(SW_COMPONENT_DIAG),Y)
            MCAL_OPT += -DHAS_SW_COMPONENT_DIAG
            SOURCES_DIAG_C += $(SW_COMPONENT_DIR)/sw_component_diag.c
        endif
    endif
