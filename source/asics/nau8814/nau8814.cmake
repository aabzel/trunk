...
if( NOT (NAU8814_CMAKE_INC STREQUAL Y))
    ...
    message(STATUS "NAU8814_COMMANDS=[${NAU8814_COMMANDS}]")
    ...
    target_sources(app PRIVATE ${NAU8814_DIR}/nau8814_drv.c)
    ...
    if(DIAG STREQUAL Y)
        if(NAU8814_DIAG STREQUAL Y)
            ...
            target_sources(app PRIVATE ${NAU8814_DIR}/nau8814_diag.c)
        endif()
    endif()

    if(CLI STREQUAL Y)
        if(NAU8814_COMMANDS STREQUAL Y)
            message(STATUS "+NAU8814_COMMANDS")
            target_compile_definitions(app PUBLIC HAS_NAU8814_COMMANDS)
            target_sources(app PRIVATE ${NAU8814_DIR}/nau8814_commands.c)
        endif()
    endif()
endif()
