...
#define SOUND_RECORDER_COMMANDS                                                                                        \
        SHELL_CMD("sound_recorder_restc", "sorrt", sound_recorder_test_rec_command, "SoundRecorderTestRec"),                        \
        SHELL_CMD("sound_recorder_rec", "sorr", sound_recorder_rec_command, "SoundRecorderRec"),                        \
        SHELL_CMD("sound_recorder_diag", "sord", sound_recorder_diag_command, "SoundRecorderDiag"),                     \
        SHELL_CMD("sound_recorder_init", "sori", sound_recorder_init_command, "SoundRecorderInit"),
