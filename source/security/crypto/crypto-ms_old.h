...
bool aes_decrypt_payload_frag(kdbx_header_entry_t* hdr, uint8_t* masterkey, kdbx_payload_t* payload);
...
bool aes_decrypt_check(kdbx_header_entry_t* hdr, uint8_t* masterkey, uint8_t* encrypted);
