...
bool aes256_ecb_decrypt(const uint8_t* key,
		const uint8_t* const data_in, uint32_t datalen,
		uint8_t* const data_out,uint32_t* returnlen);

bool aes256_ecb_encrypt(const uint8_t* key,
		uint8_t* data_in, uint32_t datalen,
		uint8_t* data_out,uint32_t* returnlen);

bool aes256_cbc_encrypt(uint8_t* const  key, uint8_t* const iv,
		uint8_t* const data, uint32_t datalen,
		uint8_t* const returndata, uint32_t* const returnlen );
