...
uint8_t aes256_init(aes256_context_t* ctx, aes256_key_t* key) {
    uint8_t ret = AES_ERROR;
    if(ctx) {
        if(key) {
...
uint8_t aes256_done(aes256_context_t* ctx) {
...
uint8_t aes256_encrypt_ecb(aes256_context_t* ctx, aes256_blk_t* buf) {
...
uint8_t aes256_decrypt_ecb(aes256_context_t* ctx, aes256_blk_t* buf) {
    if((NULL == ctx) || (NULL == buf)) {
        return AES_ERROR;
    }
