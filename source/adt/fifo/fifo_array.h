...
bool fifo_arr_init(FifoArray_t* const instance, Array_t* const heap, uint32_t capacity);
...
uint32_t fifo_arr_get_count(FifoArray_t* const instance);
uint32_t fifo_arr_get_size(FifoArray_t* const instance);
#ifdef __cplusplus
}
#endif
