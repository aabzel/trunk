...
bool float_to_rational_number(const float real_value,
                              int32_t * const numerator,
                              int32_t * const denominator);

bool float_to_integer_and_fractional(const float real_value,
...
bool float_to_rational_number_v0(const float real_value,
                                 int32_t * const numerator,
                                 int32_t * const denominator);
#ifdef __cplusplus
}
