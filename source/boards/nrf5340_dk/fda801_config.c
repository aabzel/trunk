...
const Fda801Config_t Fda801Config[]={
 {.num=FDA801_MAIN,
  ...
  .gpio.en1.port=0, .gpio.en1.pin=4,
  .gpio.en2.port=0, .gpio.en2.pin=5,
  .gpio.en3.port=0, .gpio.en3.pin=26,
  .gpio.mute.port=0,.gpio.mute.pin=10,
  .gpio.diag.port=1,.gpio.diag.pin=4,
  ...
  .RegCfgDump[0]= {
        ...
        .val.Ib0Addr.switching_frequency=SWITCH_FREQ_ON_48KHZ_336_KHZ,
        .val.Ib0Addr.fs=DIGITAL_INPUT_FRAME_SYN_FREQ_48_KHZ,
  },
