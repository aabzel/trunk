$(info NUCLEO_F429ZI_MK_INC=$(NUCLEO_F429ZI_MK_INC))
ifneq ($(NUCLEO_F429ZI_MK_INC),Y)
    NUCLEO_F429ZI_MK_INC=Y

    BOARD_CFG_DIR = $(BOARD_DIR)/nucleo_f429zi
    STM32F413ZH=Y

    OPT += -DHAS_NUCLEO_F429ZI
    NUCLEO_F429ZI=Y
    MICROCONTROLLER=Y
    STM32=Y
