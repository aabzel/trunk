...
const ParamItem_t ParamArray[] = {
    ...
    BOOT_PARAMS
                                  ...
                                  {.facility=BOOT, .id=PAR_ID_BOOT_CNT, .len=1, .type=TYPE_UINT8, .name="BootCnt"}, /*num*/
                                  {.facility=PARAM, .id=PAR_ID_TEST_ID1, .len=1, .type=TYPE_UINT8, .name="Test8"}, /*num*/
                                  {.facility=PARAM, .id=PAR_ID_TEST_ID2, .len=1, .type=TYPE_UINT16, .name="Test16"}, /*num*/
                                  {.facility=BOOT, .id=PAR_ID_REBOOT_CNT, .len=2, .type=TYPE_UINT16, .name="ReBootCnt"}, /*num*/
                                  {.facility=TIME, .id=PAR_ID_MAX_UP_TIME, .len=4, .type=TYPE_UINT32, .name="MaxUpTime"}, /*min*/
