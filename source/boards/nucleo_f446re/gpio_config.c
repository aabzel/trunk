...
const GpioConfig_t GpioConfig[] = {
...
#endif
    {.Pad={.port=PORT_C, .pin=13}, .testable=false, .name="UserBtn", .mode=GPIO_API_MODE_INPUT, .dir=GPIO_DIR_IN, .pull=GPIO__PULL_UP, /* .speed=GPIO_SPEED_FREQ_LOW, */ .mux=0, .logic_level=GPIO_LVL_LOW,},
...
#ifdef HAS_SD_CARD
    {.Pad={.port=PORT_B, .pin=4}, .name="SD_CARD_CS", .dir=GPIO_DIR_OUT, .testable=true, .mode=GPIO_API_MODE_OUTPUT, .pull=GPIO__PULL_AIR,
            /* .speed=GPIO_SPEED_FREQ_VERY_HIGH, */
     .mux=0, .logic_level=GPIO_LVL_HI},
#endif

#ifdef HAS_DWM1000
    {.Pad={.port=PORT_A, .pin=1}, .testable=true, .name="DWM1000_CS", .mode=GPIO_API_MODE_OUTPUT, .dir=GPIO_DIR_OUT, .pull=GPIO__PULL_AIR, /* .speed=GPIO_SPEED_FREQ_LOW, */ .mux=0, .logic_level=GPIO_LVL_HI,  },
    ...
    {.Pad={.port=PORT_C, .pin=8}, .testable=false, .name="DWM1000_IRQ", .mode=GPIO_API_MODE_INPUT, .dir=GPIO_DIR_IN, .pull=GPIO__PULL_AIR, /* .speed=GPIO_SPEED_FREQ_LOW, */ .mux=0, .logic_level=GPIO_LVL_LOW,  },
    {.Pad={.port=PORT_C, .pin=11}, .testable=true, .name="DWM1000_WKP", .mode=GPIO_API_MODE_OUTPUT, .dir=GPIO_DIR_OUT, .pull=GPIO__PULL_AIR, /* .speed=GPIO_SPEED_FREQ_LOW, */ .mux=0, .logic_level=GPIO_LVL_HI,  },
#endif
