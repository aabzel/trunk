...
const TimerConfig_t TimerConfig[] = {
    ...
    {.num=TIMER_MS_TICK_NUM , .bitness=32, .cnt_period_us = 1000, .period_ms = TIMER_MS_PERIOD_MS, .name="ms"},
    {.num=TIMER_RF_TUNER ,    .bitness=16, .cnt_period_us = 1,    .period_ms =0, .period_us = 0,  .period_ns = 30517,       .name="RfTuner"},
