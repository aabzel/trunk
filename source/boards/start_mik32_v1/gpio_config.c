...
#ifdef HAS_SPIFI
    {.pad={.port=2, .pin=0}, .dir=GPIO_DIR_OUT, .mode=GPIO_API_MODE_ALT1, .pull=GPIO__PULL_AIR, .mux=1, .logic_level=GPIO_LVL_LOW,
#ifdef HAS_LOG
 .name="SPIFI_SCLK", .connector1="38", .connector2="pin34",
#endif
    },
    {.pad={.port=2, .pin=1}, .dir=GPIO_DIR_OUT, .mode=GPIO_API_MODE_ALT1, .pull=GPIO__PULL_AIR, .mux=1, .logic_level=GPIO_LVL_LOW,
#ifdef HAS_LOG
 .name="SPIFI_CS", .connector1="37", .connector2="pin34",
#endif
    },
    {.pad={.port=2, .pin=2}, .dir=GPIO_DIR_INOUT, .mode=GPIO_API_MODE_ALT1, .pull=GPIO__PULL_UP, .mux=1, .logic_level=GPIO_LVL_LOW,
#ifdef HAS_LOG
 .name="SPIFI_DATA_0", .connector1="36", .connector2="pin34",
#endif
    },
    {.pad={.port=2, .pin=3}, .dir=GPIO_DIR_INOUT, .mode=GPIO_API_MODE_ALT1, .pull=GPIO__PULL_UP, .mux=1, .logic_level=GPIO_LVL_LOW,
#ifdef HAS_LOG
 .name="SPIFI_DATA_1 ", .connector1="35", .connector2="pin34",
#endif
    },
    {.pad={.port=2, .pin=4}, .mode=GPIO_API_MODE_ALT1, .pull=GPIO__PULL_UP, .mux=1, .logic_level=GPIO_LVL_LOW, .dir=GPIO_DIR_INOUT,
#ifdef HAS_LOG
 .name="SPIFI_DATA_2 ", .connector1="34", .connector2="pin34",
#endif
    },
    {.pad={.port=2, .pin=5}, .dir=GPIO_DIR_INOUT, .mode=GPIO_API_MODE_ALT1, .pull=GPIO__PULL_UP, .mux=1, .logic_level=GPIO_LVL_LOW,
#ifdef HAS_LOG
