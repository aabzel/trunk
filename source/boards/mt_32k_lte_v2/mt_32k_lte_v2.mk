$(info MT_32K_LTE_V2_MK_INC=$(MT_32K_LTE_V2_MK_INC))
ifneq ($(MT_32K_LTE_V2_MK_INC),Y)
    MT_32K_LTE_V2_MK_INC=Y

    BOARD_CFG_DIR = $(BOARD_DIR)/mt_32k_lte_v2

    # $(error BOARD_CFG_DIR=$(BOARD_CFG_DIR))

    MCAL_OPT += -DHAS_MT_32K_LTE_V2
    ...
    ifeq ($(FILE_API),Y)
        SOURCES_CONFIGURATION_C += $(BOARD_CFG_DIR)/file_api_config.c
    endif
    ...
    ifeq ($(MX25L6433F),Y)
        # $(error Add config MX25L6433F)
        SOURCES_CONFIGURATION_C += $(BOARD_CFG_DIR)/mx25l6433f_config.c
    endif
