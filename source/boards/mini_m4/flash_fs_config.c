...
const FlashFsConfig_t FlashFsConfig = {
        .page_1={    .page_offset=MEMORY_MANAGER1_OFFSET, .num=1, .size=MEMORY_MANAGER1_LENGTH,},
        .page_2={    .page_offset=MEMORY_MANAGER2_OFFSET, .num=2, .size=MEMORY_MANAGER2_LENGTH,},
};
