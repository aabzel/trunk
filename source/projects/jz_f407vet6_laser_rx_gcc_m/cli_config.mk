...
ifneq ($(CLI_CONFIG_MK_INC),Y)
    ...
    ifeq ($(LOCAL_OSCILLATOR),Y)
        LOCAL_OSCILLATOR_COMMANDS=Y
    endif

    ifeq ($(DC_CUT_FILTER),Y)
        DC_CUT_FILTER_COMMANDS=Y
    endif
    ...
    ifeq ($(MODULATOR_DEVICE),Y)
        MODULATOR_DEVICE_COMMANDS=Y
    endif
    ...
    ifeq ($(BPSK_FS4_DECODER),Y)
        BPSK_FS4_DECODER_COMMANDS=Y
    endif
