ifneq ($(FLASH_FS_MK_INC),Y)
    ...
    MCAL_OPT += -DHAS_FLASH_FS
    MCAL_OPT += -DHAS_FLASH_FS_PROC
    ...
    ifeq ($(FLASH_FS_WRITE),Y)
        ...
        MCAL_OPT += -DHAS_FLASH_FS_WRITE
    endif

    ifeq ($(CLI),Y)
        ifeq ($(FLASH_FS_COMMANDS),Y)
            MCAL_OPT += -DHAS_FLASH_FS_EXT_COMMANDS
            MCAL_OPT += -DHAS_FLASH_FS_COMMANDS
