#ifndef STORAGE_FILE_IDENTIFICATIONS_H
#define STORAGE_FILE_IDENTIFICATIONS_H
...
#ifdef HAS_CAN
#define STORAGE_CAN                    \
    PAR_ID_CAN0_BITRATE_HZ =  75,      \
    PAR_ID_CAN1_BITRATE_HZ =  76,      \
    PAR_ID_CAN2_BITRATE_HZ =  77,      \
    PAR_ID_CAN3_BITRATE_HZ =  78,      \
    PAR_ID_CAN4_BITRATE_HZ =  79,      \
    PAR_ID_CAN5_BITRATE_HZ =  80,      \
    PAR_ID_CAN6_BITRATE_HZ =  81,      \
    PAR_ID_CAN7_BITRATE_HZ =  82,      \
    PAR_ID_CAN8_BITRATE_HZ =  83,      \
    PAR_ID_CAN9_BITRATE_HZ =  84,
...
typedef enum  {
    ...
    PAR_ID_UNIT_TEST_FAILED_CNT = 150,
    PAR_ID_UNIT_TEST_FIRST_FAILED_HASH = 151,
    PAR_ID_UNIT_TEST_LAST_FAILED_HASH = 152,
    PAR_ID_TEST_END = 200,
#ifdef HAS_SDIO
...
#endif /* STORAGE_FILE_IDENTIFICATIONS_H */
