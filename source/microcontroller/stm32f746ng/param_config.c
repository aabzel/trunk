...
const ParamItem_t ParamArray[] = {
    PARAMS_BOOT PARAMS_LIGHT_NAVIGATOR PARAMS_FLASH_FS PARAMS_GNSS IWDG_PARAMS PARAMS_KEEPASS PARAMS_PASTILDA
        PARAMS_SDIO{BOOT, PAR_ID_REBOOT_CNT, 2, .type = TYPE_UINT16, "ReBootCnt"}, /*num*/
