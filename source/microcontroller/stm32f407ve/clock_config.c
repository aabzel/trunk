...
ClockConfig_t SECTION_CFG_DATA ClockConfig = {
        .irq_priority = 7,
        .core_clock_hz = 168000000,
        .pll0 = 168000000,
        .pll1 = 168000000,
        .hf_source = CLK_HI_FREQ_25MHZ,
        .lf_source = CLK_LOW_FREQ_32KHZ,
        .valid = true,
        .core_source = CLOCK_CORE_SRC_PLL0,
};

ClockHandle_t ClockInstance = { .valid = true, };
