...
#define INTERRUPT_CONFIG_SPI                                                           \
        {     .irq_n = SPI1_IRQn, .priority = 0, .on_off = true, .valid = true,},      \
        {     .irq_n = SPI2_IRQn, .priority = 3, .on_off = true, .valid = true,},      \
        {     .irq_n = SPI3_IRQn, .priority = 3, .on_off = true, .valid = true,},      \
        {     .irq_n = SPI4_IRQn, .priority = 3, .on_off = true, .valid = true,},      \
        {     .irq_n = SPI5_IRQn, .priority = 1, .on_off = true, .valid = true,},
...
const InterruptConfig_t SECTION_CFG_DATA InterruptConfig[] ={
        ...
        { .irq_n = UART7_IRQn, .priority = 1, .on_off = true, .valid = true,},
        { .irq_n = UART8_IRQn, .priority = 1, .on_off = true, .valid = true,},
