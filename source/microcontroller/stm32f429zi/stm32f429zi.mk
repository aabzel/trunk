...
ifneq ($(STM32F429ZI_MK_INC),Y)
    STM32F429ZI_MK_INC=Y

    MCU_CUSTOM_DIR = $(MICROCONTROLLER_DIR)/stm32f429zi
    ...
    SOURCES_C += $(MCU_CUSTOM_DIR)/stm32f429zi.c
    ifeq ($(NVS),Y)
        $(info Add config NVS)
    ...
    SOURCES_ASM += $(MCU_CUSTOM_DIR)/startup_stm32f429xx.S
