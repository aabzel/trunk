...
#define WU_STOP_M                  (1 << WU_STOP_S)
    ...
    {   
        ...
        volatile uint32_t SYS_MASK;   /*0õ00*/
        volatile uint32_t SYS_LEVEL;          /*0x04*/
        volatile uint32_t SYS_POWEROFF;      /*0õ08*/
        volatile uint32_t POWER_SWITCH; /*0õ0C*/
        volatile uint32_t CLOCKS_BU;   /*0õ10*/
        volatile uint32_t CLOCKS_SYS;  /*0õ14*/
        volatile uint32_t RTC_CONRTOL; /*0õ18*/
        volatile uint32_t STOP;/*0õ1Ñ*/
    } WU_TypeDef;
#endif
