...
//--------------------------
#ifdef HAS_EEPROM
#include "eeprom_register_types.h"
#endif
...
#define EEPROM_WRBEH_GLOB       3
    ...
    typedef struct
    {
        volatile EepromReg_EEDAT_t EEDAT;
        volatile EepromReg_EEA_t EEA;
        volatile EepromReg_EECON_t EECON;
        volatile EepromReg_EESTA_t EESTA;
        volatile EepromReg_EERB_t EERB;
        volatile EepromReg_EEADJ_t EEADJ;
        volatile EepromReg_NCYCRL_t NCYCRL;
        volatile EepromReg_NCYCEP1_t NCYCEP1;
        volatile EepromReg_NCYCEP2_t NCYCEP2;
