...
#define SPIFI_CONFIG_STAT_VERSION_M		    (0xFF << SPIFI_CONFIG_STAT_VERSION_S)
    ...
    typedef struct
    {
      volatile SpiFiRegCtrl_t CTRL;           //Offset: 0x000
      volatile SpiFiRegCmd_t CMD;         	  //Offset: 0x004
      volatile uint32_t ADDR;         	//Offset: 0x008
      volatile uint32_t IDATA;        	//Offset: 0x00C   
      volatile uint32_t CLIMIT;         //Offset: 0x010 
      volatile SpiFiRegData_t DATA;
#if 0
      union
      {
            volatile uint32_t DATA;			//Offset: 0x014  20
      ...
      volatile uint32_t MCMD;           //Offset: 0x018   -24
      volatile SpiFiRegStat_t STAT;           //Offset: 0x01C
