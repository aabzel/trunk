 ...
 */
typedef enum {
	HAL_GPIO_PULL_NONE = 0, /**< Подтяжка не подключаются. */
	HAL_GPIO_PULL_UP = 1,   /**< Подтяжка к питанию. */
	HAL_GPIO_PULL_DOWN = 2,  /**< Подтяжка к земле. */
	HAL_GPIO_PULL_UNDEF = 3  /**< Подтяжка к земле. */
