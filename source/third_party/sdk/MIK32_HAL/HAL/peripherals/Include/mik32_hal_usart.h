...
typedef struct __SettingTypeDef
{
     ...
     */
    MIK32_HAL_CTRL last_byte_clock;
...
{
    return local->Instance->RXDATA.dword;
}
...
{
    local->Instance->FLAGS.dword |= UART_FLAGS_CTSIF_M;
}
...
{
    local->Instance->FLAGS.dword |= UART_FLAGS_LBDF_M;
}
...
{
    local->Instance->FLAGS.dword |= UART_FLAGS_TC_M;
}
...
{
    local->Instance->FLAGS.dword |= UART_FLAGS_TXE_M;
}
...
{
    local->Instance->FLAGS.dword |= UART_FLAGS_RXNE_M;
}
...
{
    local->Instance->FLAGS.dword |= UART_FLAGS_IDLE_M;
}
...
{
    local->Instance->FLAGS.dword |= UART_FLAGS_ORE_M;
}
...
{
    local->Instance->FLAGS.dword |= UART_FLAGS_NF_M;
}
...
{
    local->Instance->FLAGS.dword |= UART_FLAGS_FE_M;
}
...
{
    local->Instance->FLAGS.dword |= UART_FLAGS_PE_M;
}
...
{
    local->Instance->FLAGS.dword = 0xFFFFFFFF;
}
