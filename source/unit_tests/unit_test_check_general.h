...
#define EXPECT_EQ(EXP, REAL)                                                                                          \
    do {                                                                                                               \
        /*int val1 = vala; */                                                                                          \
        /*int val2 = val2; */                                                                                          \
        if((EXP) != (REAL)) {                                                                                             \
            LOG_ERROR(SYS, "%s():Line: %d in Exp: %u  Real: %u", __FUNCTION__, __LINE__, EXP, REAL);                 \
            LOG_ERROR(SYS, "%s():Line: %d in Exp: %f  Real: %f", __FUNCTION__, __LINE__, EXP, REAL);                 \
            LOG_ERROR(SYS, "%s():Line: %d in Exp: 0x%x Real: 0x%x\n", __FUNCTION__, __LINE__, EXP, REAL);              \
            return false;                                                                                              \
        } else {                                                                                                       \
            /*printf ("\n OK!\n");  */                                                                                 \
        }                                                                                                              \
